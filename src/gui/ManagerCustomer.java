...
public class ManagerCustomer {
	...
	private void saveCustomer(int id ,String name,String passport,String address, int id_type) {
		if(name.isEmpty()) {
			...
			if(CustomerBUS.saveCustomer(current_id, name, passport, address, id_type)){
				current_id = 0;
			}
	...
	private void selectCustomer() {
		...
		ArrayList<Customer> lsOb = CustomerBUS.selectCustomer();
		int size  = lsOb.size();
	...
	private void selectTypeCustomer() {
		...
		lsOb =  CustomerBUS.selectTypeCustomer();
		int size = lsOb.size();
